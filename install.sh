...
conda install -c conda-forge vmtouch -y
...
colabfold-conda/bin/python3.10 -m pip install --no-warn-conflicts "colabfold[alphafold-minus-jax] @ git+https://github.com/sokrypton/ColabFold" tensorflow==2.12.0
colabfold-conda/bin/python3.10 -m pip install https://storage.googleapis.com/jax-releases/cuda11/jaxlib-0.3.25+cuda11.cudnn82-cp310-cp310-manylinux2014_x86_64.whl
colabfold-conda/bin/python3.10 -m pip install jax==0.3.25 chex==0.1.6 biopython==1.79
